...
- Forecast Accuracy & Sentiment Analytics Dashboard — `/insights` tab + `GET /analytics/{accuracy,sentiment}/{symbol}`; persists VADER compound to new `sentiment_score` measurement (Feature 12, PR #PENDING)
...
### Feature 12 · Forecast Accuracy & Sentiment Analytics Dashboard ✅ *SHIPPED (PR #PENDING)*
